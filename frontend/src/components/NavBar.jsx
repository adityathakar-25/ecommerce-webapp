    ...
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="group relative">
          ...
          {/* Dropdown menu */}
          {token && <div className="hidden group-hover:block absolute right-0 pt-4 z-50">
        ...
        <Link to="/cart" className="relative">
          ...
          <p className="absolute -right-1 -bottom-1 w-5 text-center leading-5 bg-black text-white aspect-square rounded-full text-[10px]">
            {getCartCount()}
          </p>
        </Link>
